...
import type { FacultyDivision, VerificationRequest, VerificationStatus } from "../types/api";
...
export const getMyDivision = () => apiRequest<FacultyDivision[]>("/faculty/my-division");
